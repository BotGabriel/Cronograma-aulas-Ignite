...
import { MinhLogo } from "../components/MinhaLogo";
      ...
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        <div className="max-w-[640px]">
          ...
          <h1 className="mt-8 text-[2.5rem] leading-tight">
            Conheça a gameplay avançada do Mono <strong className="text-blue-500">Yasuo</strong>&<strong className="text-red-500">Yone</strong> !
          </h1>
          <p className="mt-4 leading-relaxed font-bold">
            Acompahem um edit feito por mim e logo depois uma gameplay explicativa incrível !
          </p>
        </div>
